// ============================================================
// SHARED CONSENT UI THEME
// Edit this single file to update colors, text, and layout
// for both the Cookie Banner and the Cookie Settings Modal.
// ============================================================

export const COLORS = {
  primary: '#E30613',          // Main brand color (buttons, links, icon, toggles) - Instapost red
  primaryHover: '#C00510',     // Button hover state
  textDark: '#1e1e1e',         // Headings & dark text
  textBody: 'text-gray-600',   // Body text (Tailwind class)
...
export const LAYOUT = {
  ...
  // Buttons
  buttonBorderRadius: '',   // 'rounded-none' | 'rounded' | 'rounded-md' | 'rounded-lg' | 'rounded-xl' | 'rounded-full'
}
