...
export default function WorkCard({ data, onClick }: WorkCardProps) {
  ...
  return (
    <button
      ...
      className="relative w-full aspect-[4/3] md:aspect-[413/263] rounded-[16px] md:rounded-[24px] overflow-hidden cursor-pointer group focus:outline-none focus-visible:ring-2 focus-visible:ring-primary"
